...
var displayMap = function displayMap(item) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-118.243683, 34.052235],
    // zoom: 10,
    // interactive: false,
  ...
  item.forEach(function (loc) {
    ...
    new mapboxgl.Popup().setLngLat(loc.coordinates).setHTML("<p> Day ".concat(loc.day, ":").concat(loc.description, "</p>")).addTo(map); //Extends the mapbox to include the locations
...
var showAlert = function showAlert(type, msg, color) {
  var markup = "<div class='alert d-flex justify-content-center alert--".concat(type, " alert-").concat(color, "' role='alert'>").concat(msg, "</div>");
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Data Successfully Submitted', 'success');
          ...
          case 10:
            ...
            (0, _alert.showAlert)('error', _context.t0.response.data.message, 'danger');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Login Successfully', 'success');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"emailverify.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Token sent Successfully to your Mail', 'success');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              console.log(res.data.status);
              (0, _alert.showAlert)('Success', "".concat(type, " Successfully Submitted"), 'success');
            }
...
var stripe = Stripe('pk_test_51HSsOMEv38KztpmqUcITPjmyuuFestFzpWjq6IDYfUZ2xqOZXXz5Dkh9HUPwNVnWSi6SkF9vna3mA295rsrraQ6d00HnjpwEBG');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', _context.t0, 'danger');
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"passwordreset.js":[function(require,module,exports) {
"use strict";
...
var forgotpassword = document.querySelector('.forgot-details');
var SignupForm = document.querySelector('.Signup_form');
var userupdateform = document.querySelector('.User-data-form');
var PasswordUpdate = document.querySelector('.Password-Update');
var logout = document.querySelector('.logout');
var bookbtn = document.getElementById('book_tour');
var resetdetails = document.querySelector('.reset-details'); // const Signbtn = document.getElementById('Submit-sign');
...
if (resetdetails) {
  resetdetails.addEventListener('submit', function (e) {
    var tourId = e.target.dataset;
    console.log(tourId);
    e.preventDefault(); //const tokenI = e.target.dataset;
    //console.log(tourId);

    var password = document.getElementById('pass').value;
    var newpass = document.getElementById('pass2').value; // resetpassword(password, newpass);

    (0, _passwordreset.resetpassword)(password, newpass, tourId);
  });
}

if (mapBox) {
  var item = JSON.parse(mapBox.dataset.locations);
  (0, _mapbox.displayMap)(item);
}
...
if (Loginform) {
  Loginform.addEventListener('submit', function (e) {
    ...
    (0, _login.Login)(email, Password); // eslint-disable-next-line eol-last
  });
}
...
if (SignupForm) {
  SignupForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.getElementById('name-sign').value; // console.log(name);

    var email = document.getElementById('email-sign').value;
    var Password = document.getElementById('Password-sign').value;
    var PasswordConfirm = document.getElementById('PasswordConfirm-sign').value;
...
if (PasswordUpdate) {
  ...
  PasswordUpdate.addEventListener('submit', /*#__PURE__*/function () {
...
if (bookbtn) {
  bookbtn.addEventListener('click', function (e) {
    e.target.textContent = 'Proccessing...'; //const { tourId } = e.target.dataset;

    var info = e.target.dataset;
    console.log(info); //bookTour(tourId);
  });
}
